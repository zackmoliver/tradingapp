...
exports.generateDeterministicEquityCurve = generateDeterministicEquityCurve;
exports.calculatePerformanceMetrics = calculatePerformanceMetrics;
exports.generateDeterministicStats = generateDeterministicStats;
exports.generateDeterministicBacktest = generateDeterministicBacktest;
exports.backtestToCsv = backtestToCsv;
exports.testReproducibility = testReproducibility;
/**
 ...
 */
function generateDeterministicEquityCurve(params) {
 ...
 */
function formatDateFromOffset(startDate, offset) {
 ...
 */
function calculatePerformanceMetrics(equityCurve, startDate, endDate) {
 ...
 */
function generateDeterministicStats(seed) {
    const rng = new SimpleRng(seed);
 ...
 */
function generateDeterministicBacktest(params) {
    const seed = params.seed || 42;
    // Generate equity curve
    const equityCurve = generateDeterministicEquityCurve(params);
    // Calculate performance metrics
    const { cagr, maxDrawdown } = calculatePerformanceMetrics(equityCurve, params.start_date, params.end_date);
 ...
 */
function backtestToCsv(backtest) {
    const lines = [];
    // Add metadata
 ...
 */
function testReproducibility(params, iterations = 3) {
    const results = [];
